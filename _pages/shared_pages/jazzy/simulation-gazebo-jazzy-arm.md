...
{: .notice--info} 
All the steps we are doing in this page are readily available in the Github page as [my_robot_arm_pkg]((https://github.com/frdedynamics/ros2_students_25/tree/master/my_robotarm_pkg/)). However, in through the tutorials in this page, we will try to understand how such a full-robot-package can be created and learn about what each file and folder does. Following the steps with me will help you massively when you create your own robot in the semester project.
